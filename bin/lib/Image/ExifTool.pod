...
Tag names are case-insensitive and may be prefixed by a optional group names
...
setting (ie. '*:WhiteBalance').  And finally, a leading '-' indicates tags
to be excluded (ie. '-IFD1:*').
...
the AIPrivateData stream in PDF files.  Default is 0.
...
for XMP in recognized file types.  Default is 0.
...
when writing.  (ie. use ',\\s*' to split a comma-separated list.)  Default is
undef.
...
Binary, Charset, Composite, ExtractEmbedded, FastScan, FixBase, HtmlDump,
HtmlDumpBase, IgnoreMinorErrors, MakerNotes, ScanForXMP, TextOut, Unknown
and Verbose.
...
ListSep, StrictDate, PrintConv, Sort (if a tag list reference is given) and
StrictDate.
...
ByteOrder, Charset, Compact, Compress, FixBase, IgnoreMinorErrors and
Verbose.
...
Charset, IgnoreMinorErrors, ListSep, ListSplit, PrintConv and Verbose.
...
excluded (ie. '-comment').  An asterisk ('*') may be used for the tag name,
and is useful when a group is specified to set all tags from a group (ie.
'XMP:*').  A special feature allows tag names of the form 'SRCTAG>DSTTAG'
(or 'DSTTAGE<lt>SRCTAG') to be specified to copy information to a tag with a
...
'CommentE<lt>Filename: $filename').  Braces '{}' may be used around the tag
...
ICC-view, ICC_Profile, ID3, ID3v1, ID3v2_2, ID3v2_3, ID3v2_4, IFD0, IFD1,
IPTC, ITC, InteropIFD, JFIF, JPEG, JVC, Jpeg2000, Kodak, KodakBordersIFD,
KodakEffectsIFD, KodakIFD, KyoceraRaw, Leaf, LeafSubIFD, Leica, MAC,
...
MIE-Orient, MIE-Preview, MIE-Test, MIE-Thumbnail, MIE-UTM, MIE-Unknown,
...
PostScript, PrintIM, ProfileIFD, QuickTime, RAF, RAF2, RIFF, RMETA, Rawzor,
Real, Real-CONT, Real-MDPR, Real-PROP, Real-RA3, Real-RA4, Real-RA5,
Real-RJMD, Ricoh, SPIFF, SR2, SR2DataIFD, SR2SubIFD, SRF#, SVG, Sanyo,
Sigma, SigmaRaw, Sony, SubIFD, Track#, Vorbis, XMP, XMP-DICOM,
...
this can only be done with XMP, MIE, ICC, VRD and EXIF files.
